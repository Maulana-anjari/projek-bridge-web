  ...
  <section class="">
    ...
    <div class="row">
      <div class="col-2">
        ...
        <img src="{{storage_path('public/images/gabsi.png')}}" class="img-kop float-end">
      </div>
    ...
    <div class="row">
      <div class="col-12 page-header">
        ...
        <h6>CABOR BRIDGE TAHUN 2021</h6>
      </div>
    </div>
    <div class="row justify-content-start mt-2">
      <div class="col-2">Bulan</div><div class="col-8">: Januari</div>
    </div>
    ...
    <div class="row mt-3">
      <div class="col-12 table-responsive">
        <table class="table table-bordered table-absensi">
          ...
          <tr>
            <td>1</td>
            <td>Maulana Anjari Anggorokasih</td>
            <td>Hadir</td>
            <td>Sakit</td>
            <td>Hadir</td>
            <td>Ijin</td>
    ...
    <div class="row justify-content-end mt-2">
      <div class="col-4 text-center">
        <p class="mb-0">Kulon Progo, 31 Januari 2021</p>
        <p>Manager</p>
        <br><br><br><br>
